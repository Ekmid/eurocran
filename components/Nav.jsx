...
const Nav = () => {
  return (
    <section className="px-52 flex flex-center bg-gray-100 h-20">
      ...
      <search className='basis-1/4'>
        <form className=''>
          ...
          <button type="submit"><img className='absolute right-80 top-120' src='assets/icons/search.svg'/></button>
        </form>
      </search>
